...
export default function MusicView() {
  return (
    <div className="h-full flex flex-col bg-neutral-950">
      <div className="border-b border-neutral-900 p-4 bg-neutral-900/35 text-white flex items-center justify-between shrink-0">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar bg-neutral-950">
        {TRACKS.map((track, idx) => (
          <motion.div
            ...
            className="flex items-center justify-between p-4 hover:bg-neutral-900/50 transition-all group border-b border-neutral-900 cursor-pointer bg-neutral-950 text-neutral-300"
          >
            ...
            <div className="flex items-center gap-6 font-mono text-[10px] font-bold uppercase tracking-tighter">
              <div className="px-2 py-0.5 border border-neutral-800 text-neutral-400 group-hover:border-purple-500/50 group-hover:text-purple-300 rounded transition-colors">
                {track.duration}
              </div>
            </div>
          </motion.div>
